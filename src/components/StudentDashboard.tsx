...
import { Github, LogOut, CheckCircle2, Clock, AlertCircle, Code2, BookOpen, Loader2, Award, FolderOpen, Menu, X as CloseIcon } from 'lucide-react';
...
type ActiveView = 'exams' | 'grades' | 'projects';
                    ...
                    <div className="p-4 sm:p-8">
                      ...
                      {exam.repoName && (
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 mb-4 sm:mb-6">
                          <div className="flex items-center gap-3 px-4 py-3 bg-gray-50 rounded-xl flex-1 border-2 border-gray-200">
                            <Github className="w-5 h-5 text-gray-500 flex-shrink-0" />
                            <div className="min-w-0">
                              <p className="text-xs text-gray-500 mb-0.5">Repository</p>
                              <p className="text-sm font-mono font-bold text-gray-900 truncate">{exam.repoName}</p>
                            </div>
                          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm sm:text-base text-gray-700">
                    <p><strong>Programming Assignments:</strong> AI will clone your repository, analyze your code, and prepare personalized questions about your implementation.</p>
